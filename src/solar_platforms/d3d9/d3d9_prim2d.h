...
namespace solar {
	...
	public:
		...
		virtual void render_indexed_tris(const vec2* vertices, unsigned int vertex_count, const unsigned short* indices, unsigned int index_count, const color& color) override;

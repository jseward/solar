...
namespace solar {
	...
	public:
		...
		virtual void write_ushorts(const char* name, unsigned int size, std::function<unsigned short(unsigned int)> get_value_at_func) override;
		virtual void write_ushorts(const char* name, unsigned int size, const unsigned short* values_begin) override;
		virtual void write_int(const char* name, int value) override;
		virtual void write_ints(const char* name, unsigned int size, std::function<int(unsigned int)> get_value_at_func) override;
		virtual void write_ints(const char* name, unsigned int size, const int* values_begin) override;
		...
		virtual void write_floats(const char* name, unsigned int size, std::function<float(unsigned int)> get_value_at_func) override;
		virtual void write_floats(const char* name, unsigned int size, const float* values_begin) override;
